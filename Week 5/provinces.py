def main():
  ...
  # Print the number of elements that are "Alberta".
  print(f"\nAlberta occurs {count} times in the modified list.")
def read_list(filename):
  """Read the contents of a text file into a list, remove the first and last element from the list,
  replace all occurrences of "AB" in the list with "Alberta", count the number of elements that are
  "Alberta" and print that number.
  """
  # Create an empty list that will store the lines of text from the file.
  text_list = []
