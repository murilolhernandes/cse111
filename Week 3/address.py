...
def main():
    address = input("Enter a U.S. mailing address: ")
    print(f"The city is {extract_city(address)}")
    print(f"The state is {extract_state(address)}")
    print(f"The ZIP code is {extract_zipcode(address)}")
