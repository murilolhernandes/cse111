...
def test_convert_kPa_to_psi():
  assert convert_kPa_to_psi(0.0) == approx(0.000, abs=0.001)
  assert convert_kPa_to_psi(1.0) == approx(0.145038, abs=0.001)
  assert convert_kPa_to_psi(158.7) == approx(23.017489, abs=0.001)
  assert convert_kPa_to_psi(170.0) == approx(24.6564, abs=0.001)
  assert convert_kPa_to_psi(200.0) == approx(29.0075, abs=0.001)
  assert convert_kPa_to_psi(20) == approx(2.90075, abs=0.001)
